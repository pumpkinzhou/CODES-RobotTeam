...
path(1,1,:)=[2.2743 0.9790];path(1,2,:)=[ 2.6720 0.98];path(1,3,:)=[ 4.7065 0.9906 ];path(1,4,:)=[ 4.7065 0.9906 ];
path(1,5,:)=[ 4.7065 0.9906 ];path(1,6,:)=[ 4.7065 0.9906 ];path(1,7,:)=[ 4.7065 0.9906 ];path(1,8,:)=[ 4.7065 0.9906 ];
path(1,9,:)=[ 4.7065 0.9906 ];path(1,10,:)=[ 4.7065 0.9906 ];%define path1.

path(2,1,:)=[ 2.6889 0.6];path(2,2,:)=[  3.0526 0.6 ];path(2,3,:)=[3.0526; -0.4538];path(2,4,:)=[1.26; -0.4538];path(2,5,:)=[1.26 0.6];

path(3,1,:)=[2.2743 0.9790];path(3,2,:)=[ 2.6720 0.98];path(3,3,:)=[ 4.7065 0.9906 ];path(3,4,:)=[ 4.7065 0.9906 ];
path(3,5,:)=[ 4.7065 0.9906 ];path(3,6,:)=[ 4.7065 0.9906 ];path(3,7,:)=[ 4.7065 0.9906 ];path(3,8,:)=[ 4.7065 0.9906 ];
path(3,9,:)=[ 4.7065 0.9906 ];path(3,10,:)=[ 4.7065 0.9906 ];%define path2.
...
pathmax(3)=10;
%serial number of traffic light in each intersection
light(1,1)=1;light(1,2)=2;light(1,3)=3;light(2,4)=4;light(2,5)=5;light(2,6)=6;light(2,7)=7;light(2,8)=8;light(2,9)=9;light(2,10)=10;
...
%light_color=[0,1,1,1];
num_pololu =1;%number of cars in system
