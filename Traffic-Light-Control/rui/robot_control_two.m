function robot_control_two()
 % one robot, input leaderPos, point to point navigation
clear all; close all; clc; 
%define the path of each vehicle

path(1,1,:)=[1 1];path(1,2,:)=[1.3 1];path(1,3,:)=[2,1];path(1,4,:)=[0 0];%define path1. [0 0] is stopping mark 
path(2,1,:)=[1.3 1.3];path(2,2,:)=[1.3 1];path(2,3,:)=[1.3 0.3];path(2,4,:)=[0 0];%define path2. [0 0] is stopping mark
